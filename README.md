...
当前定位：按"170 万总 / 计划至多 126.8 万 ETF / 43.2 万稳健垫 / 目标年化 7%"标定（旧的 100万/70万/8% 已废弃；**以 HANDOFF.md §0A 为权威实时口径**）；P0/P1/P2 已落地（全组合口径风险预算、缓冲感知建议权重、分批建仓回测、目标可行性体检、危机保险提醒等）；待办与开放问题见 HANDOFF.md 第 5 节。
