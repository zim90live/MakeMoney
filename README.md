...
> ⚠️ 这是教育/辅助工具，输出的是建议，**不构成投资建议**；回测好 ≠ 未来赚钱。
...
> 海外宽基/成长（`513500`、`513100`）与 A 股成长（`159915`、`588000`）已升入可交易池 `universe`（见 [`PLAN.md`](PLAN.md) P0-4），不再属于观察池。
...
当前优化路线图见 [`PLAN.md`](PLAN.md)：按"170 万 / 至多 100 万 ETF / 70 万稳健垫 / 目标年化 8%"的真实定位重标定，
重点是**全组合口径的风险预算**与**缓冲感知的建议权重**（让稳健垫支撑 ETF 桶为目标适度加股），以及分批建仓回测与目标可行性体检。
